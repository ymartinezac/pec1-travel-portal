    ...
    return (
        <article className="presentacion">
           ...
           <h1>Presentación ViajaPR</h1>
            ...
            <p><strong>Covid-19:</strong> Por la actual pandemia, los tours se efectuan bajo estrictas medidas de sanitización. El uso de mascarillas es compulsorio, y se estará requiriendo el lavado de manos frecuentemente.</p>
